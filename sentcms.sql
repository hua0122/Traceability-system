...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=24 ;
...
(14, 'web_site_title', 'text', '网站标题', 1, '', '网站标题前台显示标题', '', 1378898976, 1379235274, 1, '溯源系统', 0),
(15, 'web_site_url', 'text', '网站URL', 1, '', '网站网址', '', 1378898976, 1379235274, 1, 'http://localhost/sentcms/', 1),
(16, 'web_site_description', 'textarea', '网站描述', 1, '', '网站搜索引擎描述', '', 1378898976, 1379235841, 1, '溯源系统', 3),
(17, 'web_site_keyword', 'textarea', '网站关键字', 1, '', '网站搜索引擎关键字', '', 1378898976, 1381390100, 1, '溯源系统', 6),
...
(12, 1, '', '测试文章的添加功能', 2, '测试文章的添加功能', 2, 1, 0, 0, 0, 1465207807, 0, 3, 0, 0, 0, 0, 1465207807, 1465207807, '2'),
...
(1, 'admin', '9d98696a650b7bd9c90f057023951aa3', 'admin', 'admin@admin.com', NULL, 0, '0000-00-00', '', 0, NULL, 0, 0, 0, 0, 'nPdbMU', 9, 0, 1489650033, 2130706433, 1518076159, 1),
...
(2, '系统', 'admin', 'laptop', 0, 11, 'admin/menu/index', 0, '', '', 0, 0),
(3, '内容', 'admin', 'list', 0, 22, 'admin/category/index', 0, '', '', 0, 0),
(4, '会员', 'admin', 'user', 0, 12, 'admin/user/index', 0, '', '', 0, 0),
(5, '运营', 'admin', 'th', 0, 44, 'admin/link/index', 1, '', '', 0, 0),
...
(29, '码段', 'admin', 'fa fa-cc', 0, 33, 'admin/code/index', 0, '', '', 0, 0),
